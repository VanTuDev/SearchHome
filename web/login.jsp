            ...
            <form class="login-form container" action="login" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="row" style="margin:0px">
                        <input class="col-9" type="text" class="form-control" name="user">
<!--                        <button class="col-1" type="button" id="showPassword">
                            <i id="showIcon" class="fa fa-eye" aria-hidden="true"></i>
                        </button>-->
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="row" style="margin:0px;justify-content: center">
                        <input class="col-9" type="password" class="form-control" name="pass" id="password">
                        <button class="col-1" type="button" id="showPassword">
                            <i id="showIcon" class="fa fa-eye" aria-hidden="true"></i>
                        </button>
                    </div>
